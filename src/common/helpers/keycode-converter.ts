...
const keymap: KeyMap = {
  ...
  enter: { linux: 28, macOS: 76, windows: null },
  ...
  return: { linux: null, macOS: 36, windows: 13 },
  delete: { linux: 111, macOS: 51, windows: 46 },
  tab: { linux: 15, macOS: 48, windows: 9 },
  spacebar: { linux: 57, macOS: 49, windows: 20 },
  shift: { linux: null, macOS: 56, windows: 10 },
  shiftRight: { linux: null, macOS: 60, windows: null },
  control: { linux: null, macOS: 59, windows: 11 },
  menu: { linux: 139, macOS: 58, windows: 18 },
  printScreen: { linux: 210, macOS: null, windows: 42 },
  ...
  macFn: { linux: null, macOS: 63, windows: null },
  macOption: { linux: null, macOS: 58, windows: null },
  macCommand: { linux: null, macOS: 55, windows: null },
  macOptionRight: { linux: null, macOS: 61, windows: null },
  macCommandRight: { linux: null, macOS: 54, windows: null },
  winLeftWindow: { linux: null, macOS: null, windows: 91 },
  winRightWindow: { linux: null, macOS: null, windows: 92 },
  winApplication: { linux: null, macOS: 110, windows: 93 },
  ...
  a: { linux: 30, macOS: null, windows: 65 },
  ...
  numEqual: { linux: 117, macOS: 81, windows: null },
};
