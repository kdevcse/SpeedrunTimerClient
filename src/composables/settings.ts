import { Store } from '@tauri-apps/plugin-store'; //https://v2.tauri.app/plugin/store
...
export function useSettings() {
  ...
  async function loadSettings(store: Store) {
  ...
  async function saveSettings(store: Store) {
